...
void ProcessFFT::setup(){
    noImage = 20;
    int noImagesLoaded = 40;
    ofImage newImage;
    for(int i = 0; i < noImagesLoaded; i++) {
        string imageName = "image"+ ofToString(i) +".jpeg";
    ...
    graphMaxSize = 20; //approx 10sec of history at 60fps
...
void ProcessFFT::setNoImage(int _img){
    noImage = _img;
}
int ProcessFFT::getNoImage(){
    return noImage;
